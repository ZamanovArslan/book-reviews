...
(function () {
  ...
  jst._tmpl['comment'] = function (data) {
    ...
    if (comment["can_modify?"]) {
      __jst += '<a data-confirm="Are you sure?" class="btn btn-danger" rel="nofollow" data-id="' + filter.html(comment.id) + '" data-method="delete" href="/reviews/' + filter.html(comment.review_id) + '/comments/' + filter.html(comment.id) + '">Delete comment</a>';
    }
  ...
  jst._tmpl['error'] = function (data) {
    ...
    __jst += '<div class="alert alert-danger" role="alert">' + filter.html(response["text"]) + '</div>';
    return __jst;
  };
})();
...
/******/ });
//# sourceMappingURL=application-541e9e3278166c783b2f.js.map