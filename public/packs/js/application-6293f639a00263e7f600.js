...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/trim */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/trim.js");
...
(function () {
  ...
  jst._tmpl['comment'] = function (data) {
    ...
    __jst += '<div class="media comment-box" data-id="' + filter.html(comment.id) + '"> <div class="media-left"> <a href="#"> <img class="img-responsive user-photo" src="https://ssl.gstatic.com/accounts/ui/avatar_2x.png" alt=""> </a> </div> <div class="media-body"> <h4 class="media-heading">' + filter.html(comment["user"]["email"]) + '<span class="float-right">' + filter.html(comment.created_at) + '</span> </h4> <p>' + filter.html(comment.text) + '</p> <a data-confirm="Are you sure?" class="btn btn-danger" rel="nofollow" data-id="' + filter.html(comment.id) + '" data-method="delete" href="/reviews/' + filter.html(comment.review_id) + '/comments/' + filter.html(comment.id) + '">Delete comment</a> </div> </div>';
    return __jst;
  };
})();
...
$(document).ready(function () {
  ...
  $("a[data-method='delete']").on("ajax:success", deleteComment(this["data-id"]));
...
/******/ });
//# sourceMappingURL=application-6293f639a00263e7f600.js.map