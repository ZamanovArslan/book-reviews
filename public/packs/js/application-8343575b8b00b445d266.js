...
(function () {
  ...
  jst._tmpl['comment'] = function (data) {
    ...
    if (comment["can_modify?"]) {
      __jst += '<a data-confirm="Are you sure?" data-remote=true class="btn btn-danger" rel="nofollow" data-id="' + filter.html(comment.id) + '" data-method="delete" href="/api/v1/reviews/' + filter.html(comment.review_id) + '/comments/' + filter.html(comment.id) + '">Delete comment</a>';
    }
...
/******/ });
//# sourceMappingURL=application-8343575b8b00b445d266.js.map