...
$(document).ready(function () {
  ...
  $("#new_comment").ajaxSuccess(function (event, xhr, settings) {
    console.log(xhr.responseText);
    console.log(settings);
  });

  _babel_runtime_corejs3_core_js_stable_instance_bind__WEBPACK_IMPORTED_MODULE_0___default()(_context = $("#new_comment")).call(_context, "ajax:success", function (event, data, status, xhr) {
    console.log(event);
    console.log(data);
  });
});
...
/******/ });
//# sourceMappingURL=application-260929cae3ddcef09fa0.js.map